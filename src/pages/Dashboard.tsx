...
const Dashboard = () => {
  ...
  return <div className="min-h-screen bg-background">
      <PageHeader title="NQIP Data Review" subtitle="Facility XYZ" period="Q3 Draft" showBackLink={false} />
      
      <main className="container mx-auto px-6 py-8">
        <div className="mb-8">
          <h2 className="text-2xl font-semibold text-foreground mb-6">Indicators Overview</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {indicators.map(indicator => <IndicatorCard key={indicator.id} {...indicator} />)}
          </div>
        </div>
        ...
        <div className="flex justify-center gap-4">
          ...
          <Button onClick={() => window.open('https://prod-apsoutheast-a.online.tableau.com/#/site/rockpool/views/NQIPQuarterlyReport/Falls?:iid=1', '_blank')} size="lg" className="px-8">
            Go To Tableau Dashboard
          </Button>
          <Button onClick={() => navigate('/validation')} size="lg" className="px-8">
